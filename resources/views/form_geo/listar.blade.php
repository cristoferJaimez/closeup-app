                ...
                <tbody>
                    @foreach ($lista as $item)
                        <tr>
                            ...
                            <td class="text-center"><!--<img src="{{$item->img}}" alt="{{$item->cod}}" class="" title="img : {{$item->cod}}" style="cursor: pointer" width="20px" height="20px">--> <a href="{{$item->img}}" class="" target="blank_">ver</a></td>
                        </tr>
