                ...
                <tbody>
                    @foreach ($lista as $item)
                        <tr>
                            ...
                            <td class="text-center"><!----> <a href="{{$item->img}}" data-lightbox="smile">  <img src="{{$item->img}}" alt="{{$item->cod}}" class="" title="img : {{$item->cod}}" style="cursor: pointer" width="20px" height="20px"></a></td>
                        </tr>
